...
class PRTR(nn.Module):
    ...
    def forward(self, inputs, masks):
        ...
        hs, encoder_memory, encoder_attn_maps, decoder_attn_maps, spatial_shapes, encoder_sampling_locations, decoder_sampling_locations, reference_points = self.transformer(
        ...
        return {
            ...
            "encoder_memory": encoder_memory, # [B, sum_l(Hl * Wl), embed_dim]
